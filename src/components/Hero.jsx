...
const Hero = () => {
  return (
    ...
    >
      ...
      >
        Convirtiendo la imaginación en{" "}
      ...
      >
        Creamos conexiones significativas y transformamos grandes ideas en
        experiencias digitales interactivas que inspiran y generan valor.
      </motion.p>
