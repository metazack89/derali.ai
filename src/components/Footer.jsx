...
const Footer = ({ theme }) => {
  return (
    ...
    >
      ...
      <div className="flex justify-between lg:items-center max-lg:flex-col gap-10">
        ...
        >
          ...
          <p className="max-w-md">
            Desde la estrategia hasta la ejecución, construimos soluciones
            digitales que llevan tu negocio al siguiente nivel.
          </p>
        ...
        >
          <h3 className="font-semibold">Suscríbete a nuestra newsletter</h3>
          <p className="text-sm  mt-2 mb-6">
            Las últimas noticias, artículos y recursos, enviados a tu bandeja de
      ...
      >
        <p>Copyright 2025 © Cristian Ortiz - Todos los derechos reservados.</p>
